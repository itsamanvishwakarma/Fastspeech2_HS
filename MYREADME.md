...
you don't need to use git-lfs to install this package.
just normally clone the repo & than follow the installation command from the README.md file.

## Also you don't need to separetly install the hifigan model, it will be automatically installed when you install this package.

## when you close the model how to restart it

when you close the model, you can restart it by running the following command:
in the current working directory of the or you can say main directory of the project run the following command:

```
conda activate tts-hs-hifigan
```

## here is the file with the limitation in case you want it
...
## here is the command of how to run the modal and accept the input from a text file

```
python inference.py --text_file textfile.txt --language hindi --gender male --alpha 1
```
